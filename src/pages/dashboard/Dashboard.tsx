...
const LabourDashboard: React.FC = () => {
    ...
    return (
        <div className="flex h-full min-h-full flex-col bg-linear-to-b from-(--linear-top) to-(--linear-bottom)">
            ...
            <div className="flex shrink-0 flex-col gap-3 px-4 pt-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
                <nav
            ...
            {/* Body */}
            <section className="flex flex-1 min-h-0 flex-row gap-4 px-4 py-4">
                <div className="grid flex-1 w-full auto-rows-fr grid-cols-3 gap-3 sm:grid-cols-3 lg:grid-cols-4 ">
                    <StatCard
                ...
                <div className="h-full w-full xl:w-80 xl:shrink-0">
                    <ChartCard />
                </div>
            </section>
        </div>
